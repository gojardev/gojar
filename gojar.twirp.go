...
/*
Package gojar is a generated twirp stub package.
...
const APIPathPrefix = "/twirp/gojar.API/"
...
func (s *aPIServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "gojar", "API")
}
